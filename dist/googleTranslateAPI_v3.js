...
function getSupportedLanguagesV3() {
 ...
 */
function callBatchTranslateText_V3(sourceLanguageCode, targetLanguageCodes, inputConfigs, outputConfig) {
    return __awaiter(this, void 0, void 0, function* () {
        // Construct request
        const request = {
            parent,
        ...
        // Run request
        const [operation] = yield translationClient.batchTranslateText(request);
        const [response] = yield operation.promise();
        console.log(response);
    });
}
exports.callBatchTranslateText_V3 = callBatchTranslateText_V3;
function callTranslateText_V3(contents, targetLanguageCode) {
    return __awaiter(this, void 0, void 0, function* () {
        // Construct request
        const request = {
            contents,
