...
exports.summarizerGoogleAPI = void 0;
...
async function summarizerGoogleAPI(text) {
    const finalText = {
...
` + text
    ...
    if (streamingResp.response) {
        const res = JSON.stringify(await streamingResp.response);
        return JSON.parse(res);
    }
}
exports.summarizerGoogleAPI = summarizerGoogleAPI;
// summarizerGoogleAPI();
