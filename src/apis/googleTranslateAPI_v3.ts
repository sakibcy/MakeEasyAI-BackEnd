...
export async function getSupportedLanguagesV3() {
    // Construct request
    const request = {
        parent,
    };
 ...
 */
export async function callBatchTranslateText_V3(sourceLanguageCode: string, targetLanguageCodes: string, inputConfigs: [], outputConfig: object) {
    // Construct request
    const request = {
        parent,
        sourceLanguageCode,
...
export async function callTranslateText_V3(contents: any, targetLanguageCode: string) {
    // Construct request
    const request = {
      contents,
      targetLanguageCode,
